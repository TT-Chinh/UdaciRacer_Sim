...
async function handleCreateRace() {
	...
	if(player_id && track_id){
		...
		try {
			...
			console.log("Problem with game start::", err);
		}
	}
}
	...
	return new Promise(resolve => {
		...
		const raceInterval = setInterval( async() => {
			const res = await getRace(raceID)
				.catch(err => console.log("Problem with get race::", err));
...
function getTracks() {
	...
	return fetch(`${SERVER}/api/tracks`)
		.then(res => res.json())
		.catch(e => console.log("Problem with get tracks: ", e))
}
...
function getRacers() {
	...
	return fetch(`${SERVER}/api/cars`)
		.then(res => res.json())
		.catch(e => console.log("Problem with get cars: ", e))
}
